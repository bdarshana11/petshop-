...
<div class="custombutton">
    <form>
        <button style=" height: 50px;width: 120px;cursor:pointer;border-radius:15px;
            border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:14px; "
                formaction="salesadd.php">Add new details
        </button>
        <button style="height: 50px;width: 110px;cursor:pointer;border-radius:15px;
            border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:14px;"
                formaction="salesupdate.php">update details
        </button>
        <button style="margin-left:800px; height: 50px;width: 110px;cursor:pointer;border-radius:15px;
            border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:14px;"
                formaction="soldproducts.php">sold products
        </button>
        <button style="height: 50px;width: 100px;cursor:pointer;border-radius:15px;
            border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:14px;"
                formaction="soldpets.php">sold pets
        </button>
    </form>
</div>
<?php
...
<form action="deletesales.php" method="post">
    ...
    <input style="width:75px;height:44px;cursor:pointer;border-radius:15px;
        border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:15px;"
           type="submit" value="Delete">
</form>
<!-- Print button -->
<button class="print-button" onclick="printPage()">Download PDF</button>
<script>
